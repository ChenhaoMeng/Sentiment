...
CONFIG = {
    ...
    'output_paths': {
        ...
        'chinese_wordcloud': '/workspace/chinese_wordcloud.png',
        'english_wordcloud': '/workspace/english_wordcloud.png',
        'comprehensive_analysis': '/workspace/comprehensive_analysis.png'
    },
